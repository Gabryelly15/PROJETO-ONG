...
<body>
    ...
    <img
      src="<?php echo $produtos[$produto_id - 1]["imagem"]; ?>"
      alt="Carrinho: <?php echo $produtos[$produto_id - 1]["nome"]; ?>"
      class=""
    />
    <div class="cart-item-info">
      <h3 class="">
      <?php echo $produtos[$produto_id - 1]["nome"]; ?>
      </h3>
      
      <p class=""><?php echo "$" . $produtos[$produto_id - 1]["preco"]; ?></p>
    </div>
    <div class=" js-botao-quantidades ">
      <div class=' quantity-btn decrease'>
          <!-- <button id='decrementar-produto-${produto.id}'>-</button> -->
          <a href="loja.php?diminuir=<?php echo $produto_id; ?>" id='decrementar-produto-<?php echo $produtos[$produto_id - 1]["id"]; ?>'>-</a>
      </div>
          <p id='quantidade-<?php echo $produtos[$produto_id - 1]["id"]; ?>' class='quantity'><?php echo $quantidade; ?></p>
    <div class=' quantity-btn increase'>
          <!-- <button id='incrementar-produto-${produto.id}'>+</button> -->
          <a href="loja.php?aumentar=<?php echo $produto_id; ?>" id='incrementar-produto-<?php echo $produtos[$produto_id - 1]["id"]; ?>'>+</a>
